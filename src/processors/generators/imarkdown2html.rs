...
inventory::submit! { crate::registries::ProcessorPlugin {
    ...
    defaults: Some(crate::config::ProcessorDefaults { output_dir: "out/imarkdown2html", ..crate::config::ProcessorDefaults::EMPTY }),
