...
/// Usage inside `impl ProductDiscovery for MyProcessor { delegate_base!(generator); ... }`
///
/// Delegates: description, processor_type, auto_detect, config_json, max_jobs, clean (generators only).
...
macro_rules! delegate_base {
    ...
    // Generator variant without auto_detect: for processors that override auto_detect
    (generator_no_auto_detect) => {
        fn description(&self) -> &str {
            self.base.description()
        }
    ...
    // Mass generator variant: includes auto_detect + clean_output_dir
    (mass_generator) => {
        fn description(&self) -> &str {
            self.base.description()
        }
    ...
    // Mass generator variant without auto_detect: for processors that override auto_detect
    (mass_generator_no_auto_detect) => {
        fn description(&self) -> &str {
            self.base.description()
        }
